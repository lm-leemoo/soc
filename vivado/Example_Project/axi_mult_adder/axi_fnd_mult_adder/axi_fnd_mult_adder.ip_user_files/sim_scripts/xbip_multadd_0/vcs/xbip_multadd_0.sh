...
#
# Generated by Vivado on Tue Nov 26 16:28:43 KST 2024
...
# Design libraries
design_libs=(xilinx_vip xpm xbip_utils_v3_0_10 xbip_pipe_v3_0_6 xbip_bram18k_v3_0_6 mult_gen_v12_0_18 xbip_dsp48_wrapper_v3_0_4 xbip_dsp48_addsub_v3_0_6 xbip_dsp48_multadd_v3_0_6 xbip_multadd_v3_0_17 xil_defaultlib)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"/mnt/hdd1/tools/xilinx/Vivado/2022.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"/mnt/hdd1/tools/xilinx/Vivado/2022.1/data/xilinx_vip/include" \
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../../axi_fnd_mult_adder.gen/sources_1/ip/xbip_multadd_0/sim/xbip_multadd_0.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.xbip_multadd_0 xil_defaultlib.glbl -o xbip_multadd_0_simv
}
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/mnt/ssd1/2024/Huins-ssd1/easysoc-pynq/sogang/export/vivado_template_rev5/template/vivado/Example_Project/axi_mult_adder/axi_fnd_mult_adder/axi_fnd_mult_adder.cache/compile_simlib/vcs"
  fi
